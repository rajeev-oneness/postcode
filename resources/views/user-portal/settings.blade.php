                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="mt-5">
                            ...
                            <form action="{{route('update.privacy')}}" method="post">
                                @csrf
                                <input type="radio" name="is_private" id="is_private" value="0" {{($user->is_private == 0)? 'checked' : ''}}> Public
                                <input type="radio" name="is_private" id="is_private" value="1" {{($user->is_private == 1)? 'checked' : ''}}> Private
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
