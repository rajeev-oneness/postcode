...
<head>
  ...
  <meta charset="utf-8" />
  <title>Business-Admin | Edit Product</title>
      ...
      <div class="container-fluid flowid">
        <div class="row">
          <div class="col-sm-12">
            ...
            @endif
              <div class="card-body">
                <form class="needs-validation" method="post" name="offr" action="{{route('business-admin.update_products')}}" enctype="multipart/form-data">
