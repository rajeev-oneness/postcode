...
<html lang="en">
  ...
  <form action="{{route('my.business.profile.update')}}" method="POST">
<head>

    <meta charset="utf-8" />
    <title>Business-Admin | Edit Profile</title>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                @endif
                  ...
                  <div class="card-body">
                    <form class="needs-validation" method="post" action="{{route('my.business.profile.update')}}" enctype="multipart/form-data">
