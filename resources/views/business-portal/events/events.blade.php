...
<head>
  ...
  <meta charset="utf-8" />
  <title>Business-Admin | Add Events</title>
      ...
      <div class="container-fluid flowid">
        <div class="row">
          <div class="col-sm-12">
            ...
            @endif
              <div class="card-body">
                <form class="needs-validation" method="post" name="event" action="{{route('business-admin.add_events')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input class="form-control" id="address" name="address" value="{{auth()->user()->address}}" type="text" placeholder="Kindly Enter" required="">
                      @error('address')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
