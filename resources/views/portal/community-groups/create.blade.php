...
<head>
  <meta charset="utf-8" />
  <title>Admin | Add Community Group</title>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
              ...
              @endif
              <div class="card-body">
                <form class="needs-validation" method="post" name="community" action="{{route('admin.community-groups.store')}}" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="form-row">
                ...
                <button class="btn btn-primary" id="submit_Community" type="submit">Add Group</button>
                </form>
              </div>
            </div>
