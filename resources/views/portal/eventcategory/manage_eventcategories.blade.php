                ...
                {{csrf_field()}}
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="event_mnanage">
                        <thead>
                          <tr>
                          <th>Sl No.</th>
...
<script>
            $(document).ready(function() {
                create_table();
                var table1 = $('#event_mnanage').DataTable();
                table1.on('draw.dt', function() {
                    $(".edit_eventcategories").click(function() {
            ...
            function create_table() {
                ...
                $("#event_mnanage").dataTable().fnDestroy()
                table = $('#event_mnanage').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": {
                        url: "{{route('admin.event_category_details')}}",
                        type: "post",
                        data: {
                            '_token': $('input[name="_token"]').val()
                        },
                        dataSrc: "eventcategory_details"
                    },
                    "dataType": 'json',
                    "columnDefs": [{
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, full, meta) {
                                ...
                                str_btns += "<a href='javascript:' class='edit_eventcategories btn btn-mini' id='" + data.e + "' title='Click To Edit' style='cursor:pointer'><i class='fa fa-edit' aria-hidden='true'></i></a>&nbsp&nbsp";

                                str_btns += "<a href='javascript:' class='delete_events btn btn-mini' id='" + data.e + "' title='Click To Delete' style='cursor:pointer'><i class='fa fa-trash' aria-hidden='true'></i></a>";
