                        ...
                        <tbody>
                          ...
                          @foreach ($faqs as $faq)
                            <tr>
                              ...
                              <td>{{$faq->answer}}</td>
                              <td>
                                <a class="edit_product" href="{{route('admin.faq.edit', encrypt($faq->id))}}" id="}}"><i class="fa fa-edit"></i></a>
                                <a class="delete_app" id="{{encrypt($faq->id)}}" onclick="return confirm('Are you sure?')" href="{{route('admin.faq.delete', encrypt($faq->id))}}"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          @endforeach
                        </tbody>
