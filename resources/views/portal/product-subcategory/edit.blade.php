        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
              ...
              @endif
              <div class="card-body">
                <form class="needs-validation" method="post" name="offr" action="{{route('product.subcategory.update')}}">
                  {{csrf_field()}}
                  <input type="hidden" name="subcategory_id" value="{{encrypt($subcategory->id)}}">
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    ...
                    <label for="validationCustom05">Sub Category Name</label>
                      <input class="form-control" id="name" name="name" type="text" value="{{$subcategory->name}}" placeholder="Enter Product Category Name" required>
                    </div>
                  </div>
